...
class DnsProtectionTests(unittest.TestCase):
    ...
    def ready_capabilities(self):
        return {
            ...
            "systemFallback": {"ok": True, "tcpDiagnosticOk": False},
            "routerDns": {
    ...
    def test_managed_dns_block_is_reversible_and_routes_only_private_names_locally(self):
        ...
        self.assertIn("'geosite:private':", prepared)
    ...
    def test_preview_reports_failed_system_fallback_and_blocks_activation(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            capabilities.update({
                ...
                "systemFallback": {"ok": False, "tcpDiagnosticOk": False},
            })
            request = mihui_server.validate_dns_protection_request(

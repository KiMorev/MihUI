...
const NODE_FLAG_PATTERNS = {
  ...
  KR: { type: 'circle', background: '#fff', circle: '#c60c30' },
  KZ: { type: 'plain', color: '#00afca' },
  ...
  TR: { type: 'plain', color: '#e30a17' },
  US: { type: 'us' },
  VN: { type: 'plain', color: '#da251d' },
};
